            ...
            <div class="p-5">
              ...
              <form action="" method="POST" class="user">
                ...
                <div class="form-group">
                  <input type="email" name="U_email" class="form-control form-control-user" id="exampleInputEmail" placeholder="Email Address">
                </div>
                <div class="form-group ">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input  type="password" name="U_password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Password">
                  </div>
                  <!-- <div class="col-sm-6">
                ...
                <a class="small" href="index.php">Already have an account? Login!</a>
                  ...
                  <?php
                   if(isset($_POST['register_btn']))
                   {
                       ...
                       $create_query= "INSERT INTO users(user_email,user_password,first_name,last_name) VALUES('$email','$password','$firstname','$lastname')";
