      ...
      <div class="card-body ">
          <form action="" method="post" enctype="multipart/form-data">
              <div class="form-group">
                              ...
                              <select required name="cat_name" id="" class="form-control">
                              <?php 
...
$insert_blog = "INSERT INTO blog(user_id,cat_name,blog_title,blog_description,blog_date,blog_image) VALUES('$user_id','$blog_cat_name','$blog_title','$blog_description','$blog_date','$blog_image')";
