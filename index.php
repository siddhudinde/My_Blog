                ...
                <div class="p-5">
                  ...
                  <form action="" method="POST" class="user">
                    <div class="form-group">
                      <input required name="u_email" type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address...">
                    </div>
                    <div class="form-group">
